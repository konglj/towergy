...
public class TemplateUtil {
	...
	private static Template configTemplate(String path, String temp)
			throws IOException {
		Configuration config = new Configuration();
		// ServletContext sc = request.getSession().getServletContext();
	...
	public static boolean toPreview(String templatePath, String threePath,
			String temp, Map<?, ?> root) {
